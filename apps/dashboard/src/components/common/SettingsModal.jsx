        ...
        <div className="popup-body">
            ...
            >
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  boxShadow:
                    language === "vi" ? "0 2px 8px rgba(0,0,0,0.05)" : "none",
                  transition: "all 0.2s",
                }}
              >
                Tiếng Việt
              ...
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  boxShadow:
                    language === "en" ? "0 2px 8px rgba(0,0,0,0.05)" : "none",
                  transition: "all 0.2s",
                }}
              >
                English
          ...
          >
            ...
            >
              ...
              >
                <div style={{ minWidth: "16px", marginTop: "2px" }}>
                  <Share size={14} />
                </div>
                <span>{t("settings.pwa_ios")}</span>
              </div>
              <div
                style={{
                  display: "flex",
              ...
              >
                ...
                <span>{t("settings.pwa_android")}</span>
              </div>
            </div>
          </div>
